...
export default function MyAppointments() {
  ...
  const getAppointmentTypeIcon = (type) => {
    switch (type) {
      case 'virtual': return <Monitor className="h-5 w-5 text-green-600" />;
      case 'personal': return <Building className="h-5 w-5 text-blue-600" />;
      ...
      <div className="relative bg-gradient-to-r from-emerald-600 to-blue-600 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center lg:text-left">
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">My Appointments</h1>
            ...
            <div className="mt-6 flex items-center justify-center lg:justify-start gap-4">
              <div className="bg-white bg-opacity-20 backdrop-blur-sm px-4 py-2 rounded-full">
                <span className="font-semibold">{appointments.length} Total Appointments</span>
              </div>
              <div className="bg-white bg-opacity-20 backdrop-blur-sm px-4 py-2 rounded-full">
          ...
          <div className="mt-6 overflow-x-auto">
            <div className="flex space-x-2 min-w-max">
              {[
                ...
                { id: "virtual", name: "Virtual Consultations", count: appointments.filter(a => a.appointmentType === "virtual").length },
                { id: "inPerson", name: "In-Person Visits", count: appointments.filter(a => a.appointmentType === "personal").length }
              ].map((tab) => (
                <button
                  key={tab.id}
                ...
                >
                  ...
                  <span className={`px-2 py-1 text-xs rounded-full ${
                    activeTab === tab.id ? "bg-white text-emerald-600" : "bg-gray-200 text-gray-600"
                  }`}>
                    {tab.count}
                  </span>
                </button>
    ...
    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      ...
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className={`flex items-center gap-1 px-3 py-1 rounded-full border ${getStatusColor(appointment.status)}`}>
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-lg font-bold text-emerald-600">₹{appointment.consultationFee}</span>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl border border-emerald-200">
            ...
            <div>
              ...
              <p className="text-emerald-600 font-medium">{appointment.doctorSpecialization}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 rounded-2xl border border-gray-200">
                ...
                <div className={`flex items-center gap-2 px-3 py-2 rounded-full border w-fit ${getStatusColor(appointment.status)}`}>
                  {getStatusIcon(appointment.status)}
              ...
              <div className="p-4 bg-gray-50 rounded-2xl border border-gray-200">
                ...
                <p className="text-2xl font-bold text-emerald-600">₹{appointment.consultationFee}</p>
              </div>
            </div>
          </div>
          ...
          {appointment.appointmentType === 'virtual' && isUpcoming && (
            <div className="p-4 bg-green-50 rounded-2xl border border-green-200">
              <h4 className="font-semibold text-green-900 mb-2">Virtual Appointment Instructions</h4>
          ...
          {appointment.appointmentType === 'personal' && isUpcoming && (
            <div className="p-4 bg-blue-50 rounded-2xl border border-blue-200">
              <h4 className="font-semibold text-blue-900 mb-2">Clinic Visit Instructions</h4>
