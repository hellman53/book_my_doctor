...
export default function AboutUs() {
  ...
  const features = [
    {
      ...
      description: "Book appointments in under a minute with our streamlined process",
      gradient: "from-emerald-500 to-emerald-600"
    },
    {
      icon: <UserCheck className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6" />,
      title: "Verified Doctors",
      description: "100% verified medical professionals with proven credentials",
  ...
  const stats = [
    { number: "100K+", label: "Happy Patients", icon: <Users className="h-3 w-3 sm:h-4 sm:w-4 lg:h-5 lg:w-5" />, color: "emerald" },
    { number: "3K+", label: "Expert Doctors", icon: <Stethoscope className="h-3 w-3 sm:h-4 sm:w-4 lg:h-5 lg:w-5" />, color: "blue" },
    { number: "50+", label: "Cities Covered", icon: <MapPin className="h-3 w-3 sm:h-4 sm:w-4 lg:h-5 lg:w-5" />, color: "violet" },
    { number: "4.9/5", label: "Patient Rating", icon: <Star className="h-3 w-3 sm:h-4 sm:w-4 lg:h-5 lg:w-5" />, color: "emerald" },
    { number: "24/7", label: "Support", icon: <Clock className="h-3 w-3 sm:h-4 sm:w-4 lg:h-5 lg:w-5" />, color: "blue" },
    { number: "99.9%", label: "Uptime", icon: <Activity className="h-3 w-3 sm:h-4 sm:w-4 lg:h-5 lg:w-5" />, color: "violet" }
  ];
  ...
  const processSteps = [
    {
      ...
      icon: <Target className="h-5 w-5 sm:h-6 sm:w-6 lg:h-7 lg:w-7 xl:h-8 xl:w-8" />,
      color: "emerald"
    },
    {
      step: "02",
      ...
      icon: <Rocket className="h-5 w-5 sm:h-6 sm:w-6 lg:h-7 lg:w-7 xl:h-8 xl:w-8" />,
      color: "blue"
    },
    {
      step: "03",
      ...
      icon: <Video className="h-5 w-5 sm:h-6 sm:w-6 lg:h-7 lg:w-7 xl:h-8 xl:w-8" />,
      color: "violet"
    },
    {
      step: "04",
  ...
  const testimonials = [
    {
      name: "Sarah Johnson",
      role: "Patient",
      content: "BookMyDoc saved me hours of waiting time. The virtual consultation was so convenient!",
      rating: 5,
      image: "👩‍💼"
    },
    {
      ...
      role: "Cardiologist",
      content: "As a doctor, I appreciate how this platform connects me with patients who need my expertise.",
      rating: 5,
      image: "👨‍⚕️"
    },
    {
      ...
      content: "Being able to book appointments during my lunch break has been life-changing!",
      rating: 5,
      image: "👩‍🎓"
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "Simply select your city, choose from verified doctors, pick your preferred time slot, and confirm. The entire process takes less than 60 seconds!"
    },
    {
      question: "Are all doctors properly verified?",
      answer: "Yes! Every doctor undergoes a rigorous 5-step verification process including license validation, qualification checks, and background verification."
    },
    {
      question: "Can I cancel or reschedule my appointment?",
      answer: "Absolutely! You can cancel or reschedule anytime up to 2 hours before your appointment without any charges."
    },
    {
      question: "Is there any booking fee?",
      answer: "Zero booking fees. You only pay the doctor's consultation fee directly after your appointment."
    },
    {
      question: "How do virtual consultations work?",
      answer: "After booking, you'll receive a secure video link. Join at your appointment time for a private HD video consultation with your doctor."
    },
    {
      question: "What if I need emergency care?",
      answer: "For medical emergencies, please contact your local emergency services immediately. We're designed for non-emergency consultations."
    }
  ];

  const technologies = [
    { name: "React & Next.js", description: "Lightning fast frontend", icon: <Laptop className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6" /> },
    { name: "Firebase", description: "Secure real-time database", icon: <Shield className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6" /> },
    { name: "WebRTC", description: "HD video calling", icon: <Video className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6" /> },
    { name: "AI/ML", description: "Smart doctor matching", icon: <Brain className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6" /> }
  ];
  ...
  return (
    <div className="mt-10 w-full bg-gradient-to-br from-gray-50 via-white to-blue-50 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute top-40 right-8 sm:right-20 w-4 h-4 sm:w-6 sm:h-6 bg-blue-200 rounded-full opacity-30 animate-float" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-40 left-1/4 w-2 h-2 sm:w-3 sm:h-3 bg-violet-400 rounded-full opacity-25 animate-float" style={{animationDelay: '4s'}}></div>
        <div className="absolute top-1/2 right-1/3 w-3 h-3 sm:w-5 sm:h-5 bg-emerald-300 rounded-full opacity-20 animate-float" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-20 left-1/3 w-3 h-3 sm:w-4 sm:h-4 bg-blue-300 rounded-full opacity-25 animate-float" style={{animationDelay: '3s'}}></div>
      </div>
        ...
        <div className="container mx-auto max-w-12xl">
          <div className={`text-center mb-8 sm:mb-12 lg:mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-gray-600 max-w-2xl sm:max-w-3xl lg:max-w-4xl mx-auto mb-8 sm:mb-10 lg:mb-12 leading-relaxed px-2">
              Experience healthcare that's <span className="font-bold text-emerald-600">faster</span>,{" "}
              <span className="font-bold text-blue-600">smarter</span>, and{" "}
              <span className="font-bold text-violet-600">more personal</span> than ever before
            </p>

            {/* Animated Stats Grid - Horizontal Scroll on Mobile */}
            <div className="relative mb-6 sm:mb-8 lg:mb-12">
              <div className="flex lg:grid lg:grid-cols-6 gap-3 sm:gap-4 overflow-x-auto lg:overflow-visible pb-4 lg:pb-0 scrollbar-hide"
                   ref={statsScrollRef}
                ...
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className={`bg-gradient-to-br from-${stat.color}-500 to-${stat.color}-600 w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto mb-2 sm:mb-3`}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-12xl">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-gray-900 mb-4 sm:mb-6">
              Why We're <span className="bg-gradient-to-r from-emerald-500 to-blue-500 bg-clip-text text-transparent">Different</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl lg:text-xl text-gray-600 max-w-2xl sm:max-w-3xl mx-auto px-2">
              We've rebuilt healthcare from the ground up with cutting-edge technology and patient-first design
            </p>
          </div>

          <div className="relative">
            <div className="flex lg:grid lg:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 overflow-x-auto lg:overflow-visible pb-6 lg:pb-0 scrollbar-hide"
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className={`bg-gradient-to-br ${feature.gradient} w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300`}>
                    <div className="text-white">
                      {feature.icon}
                    </div>
                  </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-emerald-50 via-blue-50 to-violet-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-12xl">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-gray-900 mb-4 sm:mb-6">
              How It <span className="bg-gradient-to-r from-blue-500 to-violet-500 bg-clip-text text-transparent">Works</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl lg:text-xl text-gray-600 max-w-2xl sm:max-w-3xl mx-auto px-2">
              Your journey to better health starts here. Simple, fast, and secure.
            </p>
          </div>

          <div className="relative">
            <div className="flex lg:grid lg:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 overflow-x-auto lg:overflow-visible pb-6 lg:pb-0 scrollbar-hide"
                 ref={processScrollRef}
                 style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              {processSteps.map((step, index) => (
                <div key={index} className="flex-shrink-0 w-80 sm:w-96 lg:w-auto relative">
                  <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-500 group hover:scale-105">
                    <div className={`bg-gradient-to-br from-${step.color}-500 to-${step.color}-600 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300`}>
                      <div className="text-white">
                        {step.icon}
                      </div>
                    </div>
                    <div className="text-2xl sm:text-3xl lg:text-4xl font-black text-gray-300 mb-3 sm:mb-4">{step.step}</div>
                    <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{step.title}</h3>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-12xl">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-gray-900 mb-4 sm:mb-6">
              Powered by <span className="bg-gradient-to-r from-violet-500 to-emerald-500 bg-clip-text text-transparent">Innovation</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl lg:text-xl text-gray-600 max-w-2xl sm:max-w-3xl mx-auto px-2">
              Built with the latest technology to ensure security, speed, and reliability
            </p>
          </div>
            ...
            <div className="flex lg:grid lg:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 overflow-x-auto lg:overflow-visible pb-6 lg:pb-0 scrollbar-hide"
              ...
              {technologies.map((tech, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{tech.name}</h3>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-blue-50 to-violet-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl sm:max-w-5xl lg:max-w-6xl">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-gray-900 mb-4 sm:mb-6">
              Loved by <span className="bg-gradient-to-r from-emerald-500 to-blue-500 bg-clip-text text-transparent">Thousands</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600">See what our community has to say</p>
          </div>

          <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl border border-gray-200">
            <div className="text-center mb-6 sm:mb-8">
              <div className="text-4xl sm:text-5xl lg:text-6xl mb-3 sm:mb-4">{testimonials[activeTestimonial].image}</div>
              <div className="flex justify-center mb-3 sm:mb-4">
                {[...Array(testimonials[activeTestimonial].rating)].map((_, i) => (
                  <Star key={i} className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-yellow-400 fill-current mx-0.5" />
                ))}
              </div>
              ...
              <div>
                <div className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{testimonials[activeTestimonial].name}</div>
                <div className="text-sm sm:text-base text-gray-600">{testimonials[activeTestimonial].role}</div>
              </div>
            </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl sm:max-w-3xl lg:max-w-4xl">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-gray-900 mb-4 sm:mb-6">
              Frequently Asked <span className="bg-gradient-to-r from-violet-500 to-emerald-500 bg-clip-text text-transparent">Questions</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600">Everything you need to know</p>
          </div>
