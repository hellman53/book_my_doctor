...
import { Search, MapPin, Heart, X, Clock, User, ChevronDown, Filter, Star, Calendar, Badge, Stethoscope, Award, ChevronLeft, ChevronRight } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
            ...
            <div className="bg-white shadow-lg sm:shadow-xl rounded-2xl sm:rounded-3xl border border-gray-100 p-3 sm:p-4">
              <div className="flex flex-col lg:flex-row gap-3 sm:gap-4">
                ...
                <div className="flex items-center px-3 sm:px-4 py-2 bg-gray-50 rounded-xl sm:rounded-2xl min-w-0 lg:w-56 xl:w-64">
                  ...
                  <ChevronDown className="h-3 w-3 sm:h-4 sm:w-4 text-gray-400 ml-1 sm:ml-2" />
                </div>
            ...
            {showFilters && (
              <div className="mt-4 sm:mt-6 p-4 sm:p-6 bg-gray-50 rounded-xl sm:rounded-2xl border border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2 sm:mb-3">Consultation Type</label>
                  ...
                  {/* Quick Actions */}
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2 sm:mb-3">Quick Filters</label>
              ...
              <div className="absolute top-full left-0 right-0 bg-white border rounded-lg sm:rounded-xl shadow-lg mt-2 z-50 max-h-80 sm:max-h-96 overflow-y-auto">
                ...
                {recentSearches.length > 0 && searchQuery === "" && (
                  <div className="p-3 sm:p-4 border-b">
                    <h4 className="text-xs sm:text-sm font-medium text-gray-700 mb-2">Recent Searches</h4>
                ...
                {suggestions.localities?.length > 0 && (
                  <div className="p-3 sm:p-4 border-b">
                    <h4 className="text-xs sm:text-sm font-medium text-gray-700 mb-2">Localities</h4>
                    <div className="space-y-1">
                ...
                {suggestions.specializations?.length > 0 && (
                  <div className="p-3 sm:p-4 border-b">
                    <h4 className="text-xs sm:text-sm font-medium text-gray-700 mb-2">Specializations</h4>
                    <div className="space-y-1">
                ...
                {suggestions.doctors?.length > 0 && (
                  <div className="p-3 sm:p-4">
                    <h4 className="text-xs sm:text-sm font-medium text-gray-700 mb-2">Doctors</h4>
                      ...
                      {suggestions.doctors.map((doctor) => (
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            <div>
                              <p className="text-xs sm:text-sm font-medium text-gray-900">{doctor.fullName}</p>
          ...
          {loading && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mt-2 text-sm sm:text-base">Loading doctors...</p>
            </div>
          )}
                          ...
                          <div className="flex-1 min-w-0">
                              ...
                              <div className="flex-1">
                                ...
                                {doctor.rating && (
                                  <div className="flex items-center gap-1 sm:gap-2 mb-2 sm:mb-3">
                                    ...
                                    <span className="font-semibold text-gray-900 text-sm sm:text-base">{doctor.rating}</span>
                                    {doctor.reviewCount && (
                                      <span className="text-gray-500 text-xs sm:text-sm">({doctor.reviewCount} reviews)</span>
                                    )}
                                  </div>
                                )}
                            ...
                            <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-100">
                              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 sm:gap-4">
                                <div className="flex flex-col xs:flex-row xs:items-center gap-2 sm:gap-4 sm:gap-6">
                                ...
                                <div className="flex gap-2 sm:gap-3">
                                  <button
                                    ...
                                    className="flex-1 lg:flex-none bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl font-semibold text-xs sm:text-sm transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
                                  >
                                    Book Appointment
                                  </button>
                                  <button
                                    className="px-3 sm:px-4 py-2 sm:py-3 border border-emerald-200 text-emerald-600 rounded-lg sm:rounded-xl hover:bg-emerald-50 transition-colors"
                                  >
