      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="sm:w-56 lg:w-80 flex-shrink-0 ">
          ...
          {doctor.consultationFee && (
            <div className="mb-4">
              <div className="text-xl font-bold text-gray-500">Consultation Fee - <span className="text-lg sm:text-xl font-bold text-emerald-600">₹{doctor.consultationFee}</span></div>
            </div>
          )}
